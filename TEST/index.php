...
<div id="bot_wrapper_bg">		
	...
	<div id="right" style="margin-top:10px;">
		<!--<div id="rightUpload"><a href="#"><span>Upload Your<br>Campus Picture!</span></a></div>-->
		<div id="rightLogin">
			<div class="functions_signup" style="float:left; background-color:none; border:0; border-radius:0; -moz-border-radius:0;">
			<a href="#?w=380" rel="popup_name4" class="poplight" title="UReviewDU Signup to Rate Professors Drexel">Signup</a>&nbsp;<span class="onepix">|</span>&nbsp;</div><!--function4--> <!-- SIGNUP -->
			<div class="functions_signup" style="float:left;background-color:none; border:0; border-radius:0; -moz-border-radius:0;">
