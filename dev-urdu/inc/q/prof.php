...
$pdo0 = new PDO('mysql:host=localhost;dbname=ureviewdu', $u, $p);
...
$pID5 = filter_input(INPUT_GET, 'pID', FILTER_SANITIZE_NUMBER_INT);
		$pdo5 = new PDO('mysql:host=localhost;dbname=ureviewdu', $u, $p);
...
$pID6 = filter_input(INPUT_GET, 'pID', FILTER_SANITIZE_NUMBER_INT);
		$pdo6 = new PDO('mysql:host=localhost;dbname=ureviewdu', $u, $p);
