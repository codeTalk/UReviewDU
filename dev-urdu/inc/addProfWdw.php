   ...
   <script type="text/javascript">
    ...
    <p class="sm"><br /><br /><a href="http://www.josephdickinson.com/joseph-dickinson-projects/">I established the idea</a>
     ...
     compared to one another. At the time (and still) the websites reviewing Drexel University were lacking a lot of functionality, or had hardly any reviews of professors here at Drexel. The ultimate goal forever for UReviewDU is to make for informed choice when choosing courses at Drexel.</p>
    <br />
    ...
    <ul>
    	...
    	<li class="tick">Develop a greater understanding of professor teaching style's.</li>
    ...
    <!--DISCLAIMER ///////// -->
    <div id="popup_name2" class="popup_block"><img class="left" src="img/legal.png" title="UReviewDU Legal Use of Website" width="30" height="30" /><h3>Site Disclaimer</h3><p class="sm">The content on this website is developed on a real time basis in which users can express their opinions. The opinions expressed on this site do not reflect the those of the site and/or owner.</p><br /><p class="sm">The best effort is made to ensure that this content is not malicious in form to any one person or group of persons. However given the number of submissions some content may slip through the cracks, for this reason there are links on every comment submitted that state "report to moderator". These links provide everyone a way of reporting comments that they feel are malicious.</p><br /><p class="sm">If you have any questions regarding the site or content contained within please use the contact form to the upper right and I will reply as soon as possible.</p></div><!--/popup_name2-->
   ...
   <img class="left" src="img/contact.png" title="UReviewDU Legal Use of Website" width="30" height="30" /><h3 title="Email UReviewDU">Contact UReviewDU</h3>
    ...
    <img align="left" class="left" src="img/usrRegister.png" title="UReviewDU Registration" width="30" height="30" /> <h3 title="UReviewDU User Student Registration"> User Registration</h3>
    <form action="inc/newuser_registration.php" method="post" id="userRegistration">
    ...
    <form action="#" method="post" id="userLogon">
    	<div class="field required">
	    Username: <input type="text" name="reguser" tabindex="1" /><br />
	    </div>
	    <div class="field required">
	    Password: <input type="text" name="reguser" tabindex="2" /><br />
	    </div>
	    <input type="submit" name="submitUser" />
    </form>
    </div><!--/popup_name5-->